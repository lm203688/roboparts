...
> 本文首发于 [RoboParts 机器人零件兼容性判定层](https://roboparts.cc)。供应链数据交叉引用：[roboparts.cc/api/data.json](https://roboparts.cc/api/data.json)。
...
Optimus V3的量产元年，对开源机器人构建者的选型工作流提出了新的命题。RoboParts作为机器人零件兼容性判定层，从这场量产浪潮中观察到三个趋势：
