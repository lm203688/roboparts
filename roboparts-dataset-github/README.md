...
2. **机械互换维度（"能不能拧上去"）声明率仅 5.75%。** 适用分母 435 条（总数 798 减去 363 条本身无机械接口的实体）中，仅 15 条完整声明 + 10 条部分声明；其余 410 条如实标注 `not_declared`，我们不做猜测填充。
...
## 数据概览（798 实体 · 20 品类 · 2026-09-13 更新）
...
```json
{
  "meta": {
    ...
    "category_count": 20,
    "category_counts": { "...": 0 },
    "mechanical_interface_declared_rate_pct": 5.75,
